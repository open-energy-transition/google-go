...
1. Extract data from network statistics (energy balance, capacity, prices)
2. Filter and aggregate by country or system-wide
3. Apply unit conversions and transformations
4. Generate colors for technology carriers
5. Optionally plot and save results
6. Return processed DataFrame and color mapping
