...
| :----------   | :--- | :-------------- | :--------------------------- | :--------------------------------------------------- |
| certificate   | -    | {true, false}   | true                       | If `true`, the Guarantee of Origin (GoO) market is modeled. |
