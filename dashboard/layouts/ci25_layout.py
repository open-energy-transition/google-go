...
def create_layout(data_loader):
    ...
    return dbc.Container([
        html.H3("CI_25 Scenario Analysis", className="mb-4"),
        ...
        dbc.Row([
            dbc.Col([
                dcc.Loading(
                    ...
                    type="default",
                    children=[
                        dcc.Graph(id='ci25-main-plot', style={'height': '600px'})
                    ]
                )
            ], width=12)
        ]),
        ...
        dbc.Row([
            ...
            dbc.Col([
                dcc.Loading(
                    id="ci25-secondary-loading",
                    type="default",
                    children=[
                        dcc.Graph(id='ci25-secondary-plot', style={'height': '400px'})
                    ]
                )
            ], width=9)
        ], className="mt-4"),
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody(id='ci25-summary-stats')
                ])
            ])
        ], className="mt-4")
